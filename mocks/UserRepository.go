...
// FindUserDetails provides a mock function with given fields: _a0, _a1
func (_m *UserRepository) FindUserDetails(_a0 context.Context, _a1 uint) (*dto.UserDetails, error) {
	ret := _m.Called(_a0, _a1)
